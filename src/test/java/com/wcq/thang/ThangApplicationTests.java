...
//    }
    ...
    private void jigoumi() {
        System.out.println("机构名识别");
    ...
    private void renbenrenshibie() {
        System.out.println("日本名识别");
        String[] testCase = new String[]{
    ...
    void firstDemo(){
        ...
        List<Term> segment = HanLP.segment("中华人民共和国是我亲爱的祖国！");
...
//        CustomDictionary.remove("攻城狮");
    ...
    void yingyimingshibie(){
        System.out.println("英译名识别");
        String[] testCase = new String[]{
